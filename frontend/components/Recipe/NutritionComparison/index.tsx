                    ...
                    <div className="ml-auto mr-auto  w-[85%] ">
                        <div className="flex flex-col lg:flex-row gap-14 lg:gap-8 justify-between lg:justify-around">
                            ...
                            <div className="text-[#414141] flex flex-col gap-5 pb-5 lg:mb-0">
                                ...
                                <div className="bg-[#F5EFD8]   border border-[#FFD059]  w-[70vw] sm:w-[60vw] md:w-[50vw] lg:w-[420px] mx-auto lg:mx-0 xl:w-[460px]   rounded-md flex flex-col justify-center  sm:justify-start sm:items-start gap-5 p-[3%] lg:p-[10%]">
                                    <div className="flex flex-col gap-2 sw-[50vw] sm:w-[354px] ml-[6%]   sm:mx-auto">
