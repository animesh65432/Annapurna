...
export default function ShareSection({ dishname, setisShareOPen }: Props) {
    ...
    const shareMessage = `📢 Check out this amazing recipe: ${dishname} 🚀`
            ...
            >
                <div className="relative p-6 pb-4 border-b border-gray-100">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900">Share This Recipe</h2>
                    </div>
                    <p className="text-gray-600 text-sm">Help others discover this amazing recipe!</p>
                </div>
